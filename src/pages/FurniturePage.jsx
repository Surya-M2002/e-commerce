...
import CartDrawer from '../components/furniture/CartDrawer';
import CategoryBar from '../components/furniture/CategoryBar';
import PromoBanners from '../components/furniture/PromoBanners';
import { FaCouch, FaBed, FaChair, FaUtensils, FaPaintBrush } from 'react-icons/fa';
  ...
  useEffect(() => {
    const load = async () => {
      const [cats, items] = await Promise.all([
        fetchCategories('furniture'),
        fetchProducts('furniture'),
      ]);
      setCategories(cats);
      setProducts(items);
    };
  ...
  return (
    <div className="main-layout">
      <div className="hero-section text-center py-5 border-bottom">
        <h1 className="fw-bold">Furniture</h1>
        <p className="text-muted">Comfort and style for every room</p>
        ...
        <div className="row">
          <div className="col-lg-2 d-none d-lg-block">
            <div className="sidebar">
              ...
              {categories.map((cat) => {
                const Icon = iconMap[cat.icon] || iconMap[cat.id] || FaCouch;
