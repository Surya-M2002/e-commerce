    ...
    <div className="main-layout">
      <div className="d-flex">
        <div className="sidebar bg-white shadow-sm d-none d-lg-block" style={{ width: 250, minHeight: "calc(100vh - 64px)" }}>
          ...
          <nav className="p-2">
            <Link to="/seller-dashboard" className="d-block p-3 text-decoration-none text-dark fw-semibold">
              <FaHome className="me-2" /> Dashboard
            </Link>
            <Link to="#" className="d-block p-3 text-decoration-none text-dark fw-semibold">
